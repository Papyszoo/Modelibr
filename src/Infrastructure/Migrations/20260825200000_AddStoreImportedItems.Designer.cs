...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260825200000_AddStoreImportedItems")]
    partial class AddStoreImportedItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.StoreImportedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StoreUrl", "StoreAssetId", "StoreItemId")
                        .IsUnique();

                    b.ToTable("StoreImportedItems", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Project", b =>
                {
                    ...
                    b.Property<int?>("MaxTextureSize")
                        .HasColumnType("integer");

                    b.Property<int?>("MaxTrianglesPerAsset")
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<List<string>>("PaletteHex")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasDefaultValueSql("'{}'::text[]");

                    b.Property<int?>("PixelsPerUnit")
                        .HasColumnType("integer");

                    b.Property<int?>("TargetSceneTriangles")
                        .HasColumnType("integer");

                    b.Property<double?>("UnitsPerMetre")
                        .HasColumnType("double precision");

                    b.Property<string>("UpAxis")
                        .HasMaxLength(1)
            ...
            modelBuilder.Entity("Domain.Models.ProjectProfileOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Dimension", "NormalizedName")
                        .IsUnique();

                    b.ToTable("ProjectProfileOptions", (string)null);
                });

            modelBuilder.Entity("Domain.Models.ProjectProfileValue", b =>
                {
                    b.Property<int>("ProjectId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("ProjectId", "OptionId");

                    b.HasIndex("OptionId");

                    b.ToTable("ProjectProfileValues", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.SceneAssetUsage", b =>
                {
                    ...
                    b.HasKey("SceneId", "NodeId");

                    b.HasIndex("AssetType", "AssetId");

                    b.ToTable("SceneAssetUsages");
                });
            ...
            modelBuilder.Entity("Domain.Models.ProjectProfileValue", b =>
                {
                    b.HasOne("Domain.Models.ProjectProfileOption", "Option")
                        .WithMany()
