...
internal sealed class EnvironmentMapCategoryRepository : IEnvironmentMapCategoryRepository
{
    ...
    public Task<CategoryRootInsert<EnvironmentMapCategory>> AddRootAsync(
        EnvironmentMapCategory candidate, CancellationToken cancellationToken = default)
    {
        ...
        return CategoryRootInserts.AddRootAsync(
            _context,
            _context.EnvironmentMapCategories,
            candidate,
