...
/// <summary>
/// Represents a user-configurable sprite category for organizing sprites.
...
public class SpriteCategory : AggregateRoot
{
    ...
    /// <summary>
    /// Creates a new sprite category with the specified name and optional description.
    /// </summary>
    ...
    /// <returns>A new SpriteCategory instance</returns>
    /// <exception cref="ArgumentException">Thrown when name validation fails</exception>
    public static SpriteCategory Create(string name, string? description, DateTime createdAt)
    {
        ValidateName(name);
