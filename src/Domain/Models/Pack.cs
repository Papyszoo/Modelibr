...
public class Pack : AggregateRoot
{
    ...
    /// <summary>
    /// Creates a new Pack with the specified name and optional description.
    /// </summary>
    /// <param name="name">The name of the pack</param>
    /// <param name="description">Optional description of the pack</param>
    ...
    /// <summary>
    /// Updates the name and description of the pack.
    /// </summary>
    ...
    /// <summary>
    /// Removes a model from this pack.
    /// </summary>
    ...
    /// <summary>
    /// Checks if this pack contains a model with the specified ID.
    /// </summary>
    /// <param name="modelId">The model ID to check</param>
    /// <returns>True if the model is in this pack</returns>
    ...
    /// <summary>
    /// Adds a texture set to this pack.
    /// </summary>
    ...
    public void AddTextureSet(TextureSet textureSet, DateTime updatedAt)
    {
        ...
        if (_textureSets.Any(ts => ts.Id == textureSet.Id))
            return; // Texture set already in pack
    ...
    /// <summary>
    /// Removes a texture set from this pack.
    /// </summary>
    ...
    /// <summary>
    /// Checks if this pack contains a texture set with the specified ID.
    /// </summary>
    /// <param name="textureSetId">The texture set ID to check</param>
    /// <returns>True if the texture set is in this pack</returns>
    ...
    /// <summary>
    /// Gets all texture sets in this pack.
    /// </summary>
    ...
    /// <summary>
    /// Removes a sprite from this pack.
    /// </summary>
    ...
    /// <summary>
    /// Checks if this pack contains a sprite with the specified ID.
    /// </summary>
    /// <param name="spriteId">The sprite ID to check</param>
    /// <returns>True if the sprite is in this pack</returns>
    ...
    private static void ValidateName(string name)
    {
        if (string.IsNullOrWhiteSpace(name))
            throw new ArgumentException("Pack name cannot be null or empty.", nameof(name));
