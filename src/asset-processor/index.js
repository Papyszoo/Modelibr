...
/**
 * Main application class for the Modelibr Asset Processor Service.
 * Processes thumbnail generation, waveform generation, and (future) mesh analysis.
 */
class AssetProcessorApp {
  ...
  async start() {
    try {
      logger.info('Starting Modelibr Asset Processor Service', {
...
const app = new AssetProcessorApp()
