...
export const TEXTURE_TYPE_INFO: Partial<Record<TextureType, TextureTypeInfo>> = {
  ...
  [TextureType.Height]: {
    label: 'Height',
    description: 'Height map for parallax/displacement (exclusive with Bump/Displacement)',
    color: '#8b5cf6', // Purple
    icon: 'pi-chart-line',
  },
  [TextureType.AO]: {
  ...
  [TextureType.Bump]: {
    label: 'Bump',
    description: 'Bump map for surface detail (exclusive with Height/Displacement)',
  ...
  [TextureType.Displacement]: {
    label: 'Displacement',
    description: 'Displacement map for vertex displacement (exclusive with Height/Bump)',
