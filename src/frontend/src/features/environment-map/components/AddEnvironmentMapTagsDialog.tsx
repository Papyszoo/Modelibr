...
interface AddEnvironmentMapTagsDialogProps {
  visible: boolean
...
export function AddEnvironmentMapTagsDialog({
  visible,
  availableTags,
  selectedCount,
  onHide,
  onConfirm,
}: AddEnvironmentMapTagsDialogProps) {
  ...
  return (
    ...
    >
      <div className="environment-map-add-tags-dialog">
        ...
        <div className="environment-map-add-tags-input-row">
          <InputText
            value={inputValue}
            ...
            className="environment-map-add-tags-input"
          />
          <Button
            label="Add"
            icon="pi pi-plus"
        ...
        {pendingTags.length > 0 ? (
          <div className="environment-map-add-tags-selected">
            {pendingTags.map(tag => (
              <Chip
                key={tag}
                label={tag}
        ...
        {availableSuggestions.length > 0 ? (
          <div className="environment-map-add-tags-suggestions">
            <span className="environment-map-add-tags-suggestions-label">
              Existing tags
            </span>
            <div className="environment-map-add-tags-suggestions-list">
