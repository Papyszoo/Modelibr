...
interface SpriteCategoryTabsProps {
  ...
  onEditCategory: (category: SpriteCategoryDto) => void
  onDeleteCategory: (category: SpriteCategoryDto) => void
}

export function SpriteCategoryTabs({
  categories,
  sprites,
  activeCategoryId,
  dragOverCategoryId,
