...
export function useModelGrid({
  ...
  const data = useModelData({
    ...
    minTriangleCount: filters.minTriangleCount,
    maxTriangleCount: filters.maxTriangleCount,
    uvStatus: filters.uvStatus,
    textureSetId,
  ...
  return {
    ...
    animatedOnly: filters.animatedOnly,
    setAnimatedOnly: filters.setAnimatedOnly,
    minTriangleCount: filters.minTriangleCount,
    setMinTriangleCount: filters.setMinTriangleCount,
    maxTriangleCount: filters.maxTriangleCount,
    setMaxTriangleCount: filters.setMaxTriangleCount,
    uvStatus: filters.uvStatus,
    setUvStatus: filters.setUvStatus,
    effectivePackIds: filters.effectivePackIds,
    effectiveProjectIds: filters.effectiveProjectIds,
