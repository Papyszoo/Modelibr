...
const PLACEHOLDER_ANIMATIONS = [
  { id: 1, name: 'Walk_Cycle.fbx', duration: '2.5s', fps: 30, frames: 75, size: '1.2 MB' },
  { id: 2, name: 'Idle_Animation.glb', duration: '5.0s', fps: 24, frames: 120, size: '850 KB' },
  { id: 3, name: 'Jump_Sequence.bvh', duration: '1.8s', fps: 60, frames: 108, size: '540 KB' },
  { id: 4, name: 'Dance_Motion.dae', duration: '15.2s', fps: 30, frames: 456, size: '3.1 MB' },
]
    ...
    <div className="animation-list">
      <header className="animation-list-header">
        ...
        <div className="animation-stats">
          ...
          <span className="stat-item">
            <i className="pi pi-clock"></i>
            {animations.reduce((total, anim) => total + parseFloat(anim.duration), 0).toFixed(1)}s total
          </span>
        </div>
      </header>
      ...
      <div className="animation-list-content">
        ...
        >
          ...
          <Column field="duration" header="Duration" body={durationBodyTemplate} sortable />
        ...
        <div className="animation-preview">
          ...
          <div className="animation-details">
            ...
            <div className="detail-row">
              ...
              <span className="value">{selectedAnimation.frames} @ {selectedAnimation.fps}fps</span>
            </div>
            <div className="detail-row">
          ...
          <div className="animation-placeholder">
            <i className="pi pi-play" style={{ fontSize: '4rem', color: '#9ca3af' }}></i>
