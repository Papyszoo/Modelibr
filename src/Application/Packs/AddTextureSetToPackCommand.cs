...
internal class AddTextureSetToPackCommandHandler : ICommandHandler<AddTextureSetToPackCommand>
{
    private readonly IPackRepository _packRepository;
    private readonly ITextureSetRepository _textureSetRepository;
    private readonly IDateTimeProvider _dateTimeProvider;

    public AddTextureSetToPackCommandHandler(
    ...
    public async Task<Result> Handle(AddTextureSetToPackCommand command, CancellationToken cancellationToken)
    {
        ...
        pack.AddTextureSet(textureSet, _dateTimeProvider.UtcNow);
...
public record AddTextureSetToPackCommand(int PackId, int TextureSetId) : ICommand;
