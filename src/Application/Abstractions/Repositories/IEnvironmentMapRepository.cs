...
public interface IEnvironmentMapRepository
{
    ...
    Task<IReadOnlyList<EnvironmentMap>> GetByIdsAsync(
    ...
    Task<EnvironmentMap?> GetDeletedByFileHashAsync(string sha256Hash, CancellationToken cancellationToken = default);
