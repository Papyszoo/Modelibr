...
export class SpriteListPage {
    ...
    /**
     * Navigate to the sprites page via UI interaction
     */
    async goto(): Promise<void> {
        await navigateToTab(this.page, "sprites");
        await this.page.waitForLoadState("domcontentloaded");
        // Wait for sprites grid to be visible
        await this.page
            .waitForSelector(this.spriteGrid, {
                state: "visible",
                timeout: 10000,
            })
            .catch(() => {
    ...
    async clickRecycleMenuItem(): Promise<void> {
        ...
        await menu
            ...
            .click();
        // Wait for the context menu to close and operation to complete
        // Optional: context menu may already be closed
        await this.page
