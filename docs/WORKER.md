...
**Fixed with single-stage Docker build:**
- Combined build and runtime stages to ensure environment compatibility
- All dependencies (build tools + runtime libraries) installed in same image
- TensorFlow native bindings compiled directly in runtime environment
- Includes: python3, make, g++, libstdc++6, libgomp1

**This ensures TensorFlow works correctly with all required libraries available.**
