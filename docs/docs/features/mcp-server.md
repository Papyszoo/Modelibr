...
| `get_asset`                    | The derived metadata, part list (each part with its measured `bounds`) and `materialSlots` for an asset, plus `surfaces` - the horizontal faces something can be rested on, largest first, each with its height above the asset's base. Worth reading before stacking: `place_asset(on:)` rests a node on the target's _whole-asset_ box top, which is right for a table and wrong for a sofa. Also `suggestedCategories` (deterministic concept-label suggestions the user/agent can confirm-assign). Defaults to the asset's **active** version; pass the `versionId` from a search hit to inspect exactly the version that hit named.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
