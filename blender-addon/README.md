...
3. Click **Install...** and select the `modelibr` folder (or create a zip of it first)
4. Enable the addon by checking the checkbox next to "Import-Export: Modelibr"

Alternatively, you can manually copy the `modelibr` folder to your Blender addons directory:
